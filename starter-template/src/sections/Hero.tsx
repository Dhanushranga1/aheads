...
export default function Hero() {
    return (
        <section className="relative w-full py-12 md:py-32 bg-gradient-to-b from-orange-50 to-gray-50 overflow-hidden">
            {/* Background Overlay */}
            ...
            <div className="relative z-10">
                <div className="container space-y-8 px-4 text-center">
                    ...
                    <motion.div
                        ...
                        className="bg-white text-black p-4 md:p-6 rounded-lg shadow-2xl mx-2"
                    >
                    ...
                    <motion.div
                        ...
                        className="form-container mt-8 p-6 bg-gray-100 rounded-lg shadow-lg mx-2"
                    >
                        <form className="email-form">
                            ...
                            <div className="form-group flex flex-col items-center gap-4">
                                <input
                                    type="email"
                                    id="email"
                                    name="email"
                                    ...
                                    required
                                    className="email-input w-full text-black p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                                />
                                <button
                                    type="submit"
                                    className="submit-button w-full bg-orange-500 text-white py-3 px-6 rounded-md shadow-md hover:bg-blue-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500"
                                >
                                    Get the Brochure
                                </button>
                            </div>
